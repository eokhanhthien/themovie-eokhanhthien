...
const getHome = {
    ...
    getMediaUrl(params) {
        ...
        return axioGetMedia.get(`https://ga-mobile-api.loklok.tv/cms/app/media/previewInfo?category=${category}&contentId=${id}&episodeId=${episodeId}&definition=${definition}`, {mode: 'cors',withCredentials: false});
    },
}
